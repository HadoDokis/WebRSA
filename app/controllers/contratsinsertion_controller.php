    ...
    **/
	...
	// 			'PersonneReferent'
		...
		*/
		...
		public function index( $personne_id = null ){
			...
			$this->Contratinsertion->Personne->unbindModelAll();
	...
	// debug($dsp);
		...
		*/
		...
		function _add_edit( $id = null ) {
			...
			$this->Contratinsertion->unbindModelAll();
			$nbrCi = $this->Contratinsertion->find( 'count', array( 'conditions' => array( 'Contratinsertion.personne_id' => $personne_id ), 'contain' => false ) );
	...
	// debug( $this->data['Personne']['Dsp'] );
			...
			if( !empty( $referent_id ) && !empty( $this->data['Contratinsertion']['referent_id'] ) ) {
				...
				$this->Contratinsertion->Structurereferente->Referent->unbindModelAll();
