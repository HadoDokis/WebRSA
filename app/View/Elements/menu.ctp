	...
	$items = array(
		...
		'Tableaux de bord' => array(
			...
			'Tableaux de suivi d\'activité' => array(
				...
				__d( 'tableauxsuivispdvs93', '/Tableauxsuivispdvs93/tableau1b4new/:heading' ) => array( 'url' => array( 'controller' => 'tableauxsuivispdvs93', 'action' => 'tableau1b4new' ) ),
				...
				__d( 'tableauxsuivispdvs93', '/Tableauxsuivispdvs93/tableau1b5new/:heading' ) => array( 'url' => array( 'controller' => 'tableauxsuivispdvs93', 'action' => 'tableau1b5new' ) ),
