...
<div class="with_treemenu">
	...
	<?php if( $this->Permissions->check( 'contratsinsertion', 'add' ) ):?>
		<ul class="actionMenu">
			<?php
						...
						echo $this->Xhtml->tableCells(
							array(
								...
								$this->Xhtml->validateLink(
									...
									$this->Permissions->check( 'contratsinsertion', 'valider' ) && !$contratenep

								),
								$this->Xhtml->actionsLink(
									'Actions pour le CER',
									array( 'controller' => 'actionsinsertion', 'action' => 'index', $contratinsertion['Contratinsertion']['id'] ),
									$this->Permissions->check( 'actionsinsertion', 'index' ) && !$contratenep
								),
								$this->Xhtml->viewLink(
									'Voir le CER',
								...
								$this->Xhtml->fileLink(
									...
									$this->Permissions->check( 'contratsinsertion', 'filelink' )
								),
