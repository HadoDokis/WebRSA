			...
			echo $this->Default2->index(
				...
				array(
					'actions' => array(
						...
						'Traitementspcgs66::edit' => array( 'disabled' => '\'#Traitementpcg66.annule#\' == \'O\' || \''.$this->Permissions->check( 'traitementspcgs66', 'edit' ).'\' != \'1\'' ),

						'Traitementspcgs66::print' => array( 'label' => 'Fiche de calcul', 'url' => array( 'controller' => 'traitementspcgs66', 'action'=>'printFicheCalcul' ), 'disabled' => '\'#Traitementpcg66.annule#\' == \'O\' || \'#Traitementpcg66.typetraitement#\' != \'revenu\' || \''.$this->Permissions->check( 'traitementspcgs66', 'printfichecalcul' ).'\' != \'1\'' ),

						'Traitementspcgs66::printModeleCourrier' => array( 'label' => 'Imprimer courrier', 'url' => array( 'controller' => 'traitementspcgs66', 'action'=>'printModeleCourrier' ), 'disabled' => '\'#Traitementpcg66.annule#\' == \'O\' || \'#Traitementpcg66.typetraitement#\' != \'courrier\' || \''.$this->Permissions->check( 'traitementspcgs66', 'printModeleCourrier' ).'\' != \'1\'' ),
						...
						'Traitementspcgs66::clore' => array( 'disabled' => '\'#Traitementpcg66.clos#\' == \'O\' || \'#Traitementpcg66.annule#\' == \'O\' || \''.$this->Permissions->check( 'traitementspcgs66', 'clore' ).'\' != \'1\'', 'confirm' => 'Confirmer la clôture de ce traitement ?' ),

						'Traitementspcgs66::cancel' => array( 'disabled' => '\'#Traitementpcg66.annule#\' == \'O\' || \''.$this->Permissions->check( 'traitementspcgs66', 'cancel' ).'\' != \'1\'', 'confirm' => 'Confirmer l\'annulation de ce traitement ?' ),

						'Traitementspcgs66::delete' => array( 'disabled' => '\'#Traitementpcg66.annule#\' == \'O\' || \''.$this->Permissions->check( 'traitementspcgs66', 'delete' ).'\' != \'1\'', 'confirm' => 'Confirmer la suppression de ce traitement ?' ),
