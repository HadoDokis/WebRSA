	...
	foreach( $dossiers[$theme]['liste'] as $i => $dossiercov ) {
		...
		echo $this->Xhtml->tableCells(
			array(
				...
				implode( ' - ', Hash::filter( array( $dossiercov['Typeorient']['lib_type_orient'], $dossiercov['Structurereferente']['lib_struc'], implode( ' ', Hash::filter( array( $dossiercov['Referent']['qual'], $dossiercov['Referent']['nom'], $dossiercov['Referent']['prenom'] ) ) ) ) ) ),
