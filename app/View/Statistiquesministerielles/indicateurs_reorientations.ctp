...
?>
<?php echo $this->Form->create( 'Statistiquesministerielle', array( 'type' => 'post', 'action' => '/indicateursReorientations/', 'id' => 'Search', 'class' => ( !empty( $this->request->data ) ? 'folded' : 'unfolded' ) ) );?>
