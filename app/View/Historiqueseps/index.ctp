			...
			foreach( $passages as $passsage ) {
				echo $this->Xhtml->tableCells(
					array(
						...
						$this->Xhtml->link( 'Passage', array( 'controller' => 'historiqueseps', 'action' => 'view_passage', $passsage['Passagecommissionep']['id'] ), array( 'class' => 'button view', 'enabled' => $this->Permissions->check( 'historiqueseps', 'view_passage' ) ) ),
						// FIXME
// 						$this->Xhtml->link( 'Dossier', array( 'controller' => 'historiqueseps', 'action' => 'view_dossier', $passsage['Dossierep']['id'] ), array( 'class' => 'button view', 'enabled' => $this->Permissions->check( 'historiqueseps', 'view_dossier' ) ) ),
