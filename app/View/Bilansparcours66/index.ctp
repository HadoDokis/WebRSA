<?php
	...
	foreach ($bilansparcours66 as $key => $bilanparcours66) {
		...
		if (in_array($bilanparcours66['Avis']['decision'], array('reorientation', 'reorientationprofverssoc', 'maintien'))) {
		...
		$decision[] = $bilanparcours66['Avis']['thematique'] === 'Parcours'
			? value($options['Decisionsaisinebilanparcoursep66']['decision'], $bilanparcours66['Decision']['decision'])
			: value($options['Decisiondefautinsertionep66']['decision'], $bilanparcours66['Decision']['decision']);
		
		// Dans le cas d'une réorientation, on ajoute l'orientation choisie
		if (in_array($bilanparcours66['Decision']['decision'], array('reorientation', 'reorientationprofverssoc', 'maintien'))) {
