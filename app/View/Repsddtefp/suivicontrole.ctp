...
<?php
	echo $this->Form->create( 'ReportingApre', array( 'url' => Router::url( null, true ), 'id' => 'ReportingApre', 'class' => ( !empty( $this->request->data ) ? 'folded' : 'unfolded' ) ) );
		...
		<ul class="actionMenu">
			...
			<li><?php
				echo $this->Xhtml->exportLink(
					...
					array( 'controller' => 'repsddtefp', 'action' => 'exportcsv' ) + Set::flatten( $this->request->data, '__' )
				);
			?></li>
		</ul>
		<?php echo $pagination;?>
