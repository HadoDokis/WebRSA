	...
	<div id="tabbedWrapper" class="tabs">
		...
		<div id="entretiens">
			<h2 class="title">Entretiens</h2>
				<?php if( $this->Permissions->check( 'entretiens', 'add' ) ):?>
					<ul class="actionMenu">
						<?php
							echo '<li>'.
								$this->Xhtml->addLink(
