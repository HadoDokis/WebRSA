...
<?php echo $this->Xform->create( 'Comiteapre', array( 'type' => 'post', 'action' => '/index/', 'id' => 'Search', 'class' => ( ( is_array( $this->request->data ) && !empty( $this->request->data ) ) ? 'folded' : 'unfolded' ) ) );?>
	...
	<fieldset>
		...
		<fieldset>
			...
			<?php echo $this->Xform->input( 'Comiteapre.datecomite_to', array( 'label' => 'Au (exclus)', 'type' => 'date', 'dateFormat' => 'DMY', 'maxYear' => date( 'Y' ) + 5, 'minYear' => date( 'Y' ) - 120, 'selected' => $datecomite_to ) );?>
		</fieldset>
	</fieldset>
