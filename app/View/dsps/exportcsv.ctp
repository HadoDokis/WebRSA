<?php
	...
	$csv->addRow( array( 'N° Dossier', 'N° CAF',  'Nom/Prénom allocataire', 'Code secteur d\'activité', 'Code métier', 'Secteur dernière activité dominante', 'Dernière activité dominante', 'Code secteur recherché', 'Code métier recherché', 'Secteur activité recherché', 'Activité recherchée' ) );
	...
	echo $csv->render( 'dsps-'.date( 'Ymd-Hhm' ).'.csv' );
?>