<?php
	/**
	 * Code source de la classe Orientsstructs2Controller.
	 *
	 * PHP 5.3
	 *
	...
	/**
	 * La classe Orientsstructs2Controller ...
	 *
	 * @package app.Controller
	 */
	class Orientsstructs2Controller extends AppController
	{
		/**
		 * Nom du contrôleur.
		 *
		...
		/**
		 * @fixme Retirer pour add/edit/... laisser pour :filelink
		 *
		 * @var array
		 */
		public $commeDroit = array(
			'add' => 'Orientsstructs:add',
			'ajaxfileupload' => 'Orientsstructs:filelink',
			'ajaxfiledelete' => 'Orientsstructs:filelink',
			'delete' => 'Orientsstructs:delete',
			'download' => 'Orientsstructs:filelink',
			'edit' => 'Orientsstructs:edit',
			'filelink' => 'Orientsstructs:filelink',
			'fileview' => 'Orientsstructs:filelink',
			'index' => 'Orientsstructs:index',
			'impression' => 'Orientsstructs:impression',
			'impression_changement_referent' => 'Orientsstructs:printChangementReferent',
		);
		...
		public function filelink( $id ) {
			...
			$this->set( 'urlmenu', "/orientsstructs2/index/{$personne_id}" );
		 ...
		 *
		 * @see Orientsstructs2Controller::edit()
		 */
		public function add() {
			$args = func_get_args();
