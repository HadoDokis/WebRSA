		...
		protected $_querydatas = array(
			'searchDossier' => array(
				'fields' => array(
					...
					42 => 'PersonneReferent.referent_id',
					43 => '( ( "Referentparcours"."qual" || \' \' || "Referentparcours"."nom" || \' \' || "Referentparcours"."prenom" ) ) AS "Referentparcours__nom_complet"',
					44 => 'Structurereferenteparcours.lib_struc',
				),
				'recursive' => '-1',
				'joins' => array(
					0 => array(
