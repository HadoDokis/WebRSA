<?php
	...
	*/
    ...
    class AnomaliesbddShell extends Shell
    {
		...
		/// Paramètres
		public $type = 'short';
		public $dossiersvides = true;
		public $dossierssansdemandeur = true;
		public $nirsdoublonsfoyersdiff = true;
		public $nirsdoublonsmemefoyer = true;
		public $personnesdoublonsfoyersdiff = true;
		public $personnesdoublonsmemefoyer = true;
		public $demcjtmultiples = true;
