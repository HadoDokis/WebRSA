 ...
 */
    ...
    **/
    ...
    function addEquipeLink( $title, $url, $enabled = true ) {
        $content = $this->image(
                'icons/add.png',
                array( 'alt' => '' )
    ...
    **/
    ///Boutons à utiliser pour les Equipes pluridisciplinaires
    function conseilLink( $title, $url, $enabled = true ) {
        $content = $this->image(
            'icons/door_out.png',
            array( 'alt' => '' )
        ).' Traitement par CG';
    ...
    **/
    ///Boutons à utiliser pour les Equipes pluridisciplinaires
    function decisionLink( $title, $url, $enabled = true ) {
        $content = $this->image(
    ...
    **/
    ///Boutons à utiliser pour les Equipes pluridisciplinaires
    function equipeLink( $title, $url, $enabled = true ) {
        $content = $this->image(
            'icons/door_out.png',
            array( 'alt' => '' )
    ...
    **/
    ///Boutons à utiliser pour les Equipes pluridisciplinaires
    function ordreLink( $title, $url, $enabled = true ) {
        $content = $this->image(
            'icons/book_open.png',
            array( 'alt' => '' )
        ).' Ordre du jour';
    ...
    **/
    ...
    function treatmentLink( $title, $url, $enabled = true ){
        $content = $this->image(
            'icons/page_attach.png',
            array( 'alt' => '' )
        ).' Traitements';
    ...
    **/
    ...
    function reorientLink( $title, $url, $enabled = true ){
        $content = $this->image(
            'icons/door_out.png',
            array( 'alt' => '' )
        ).' Réorientation';
    ...
    **/
    ...
    function boolean( $boolean, $showIcon = true ) {
        // TODO: avec 1 et 0
