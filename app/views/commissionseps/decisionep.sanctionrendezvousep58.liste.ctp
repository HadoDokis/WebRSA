	...
	foreach( $dossiers[$theme]['liste'] as $i => $dossierep ) {
		...
		echo $xhtml->tableCells(
			array(
				...
				array( @$regularisationlistesanctionseps58['Decisionsanctionrendezvousep58']['regularisation'][Set::classicExtract( $decisionep, "regularisation" )], array( 'id' => "Decisionsanctionrendezvousep58{$i}regularisation" ) ),
