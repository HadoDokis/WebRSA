	...
	foreach( $dossiers[$theme]['liste'] as $i => $dossierep ) {
		...
		echo $xhtml->tableCells(
			array(
				...
				array( $typesorients[Set::classicExtract( $decisioncg, "typeorient_id" )], array( 'id' => "Decisionreorientationep93{$i}TypeorientId" ) ),
				array( $structuresreferentes[Set::classicExtract( $decisioncg, "typeorient_id" ).'_'.Set::classicExtract( $decisioncg, "structurereferente_id" )], array( 'id' => "Decisionreorientationep93{$i}StructurereferenteId" ) ),
