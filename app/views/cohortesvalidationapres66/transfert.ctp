...
<?php echo $xform->create( 'Cohortevalidationapre66', array( 'type' => 'post', 'action' => 'transfert', 'id' => 'Search', 'class' => ( ( is_array( $this->data ) && !empty( $this->data ) ) ? 'folded' : 'unfolded' ) ) );?>
...
<?php if( isset( $cohortevalidationapre66 ) ):?>
    <?php if( is_array( $cohortevalidationapre66 ) && count( $cohortevalidationapre66 ) > 0  ):?>
        <?php echo $form->create( 'TransfertApre', array( 'url'=> Router::url( null, true ) ) );?>
		<?php
...
// debug($validationapre);
                    ...
                    $array2 = array(
                        ...
                        $form->input( 'Apre66.'.$index.'.istransfere', array( 'label' => false, 'type' => 'checkbox', 'value' => $validationapre['Apre66']['istransfere'], 'disabled' => $fieldsDisabled ) ).
                        $form->input( 'Apre66.'.$index.'.id', array( 'label' => false, 'type' => 'hidden', 'value' => $validationapre['Apre66']['id'], 'disabled' => $fieldsDisabled ) ).
