		...
		<fieldset>
			...
			<?php
				if( Configure::read( 'Cg.departement') == 58 ){
					echo $form->input( 'Rendezvous.statutrdv_id', array( 'label' =>  ( __d( 'rendezvous', 'Rendezvous.statutrdv', true ) ), 'type' => 'select', 'options' => $statutrdv, 'empty' => true ) );
				}
				else{
					echo $form->input( 'Rendezvous.statutrdv_id', array( 'label' =>  required( __d( 'rendezvous', 'Rendezvous.statutrdv', true ) ), 'type' => 'select', 'options' => $statutrdv, 'empty' => true ) );
				}
			?>
