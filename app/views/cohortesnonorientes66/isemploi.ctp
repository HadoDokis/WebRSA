...
//             debug($typeorient_id);
				$tableCells = array(
						...
						$xform->input( 'Orientstruct.'.$index.'.typeorient_id', array( 'label' => false, 'type' => 'select', 'options' => $typesOrient, 'value' => ( !empty( $typeorient_id ) ? $typeorient_id : $cohortenonoriente66['Orientstruct']['typeorient_id'] ) ) ).
						...
						$xform->input( 'Orientstruct.'.$index.'.structurereferente_id', array( 'label' => false, 'type' => 'select', 'options' => $structuresReferentes, 'value' => ( !empty( $structurereferente_id ) ? $structurereferente_id : $cohortenonoriente66['Orientstruct']['structurereferente_id'] ) ) ),
