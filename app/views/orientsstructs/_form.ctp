...
<script type="text/javascript">
    ...
    <?php
        ...
        echo $default2->subform(
            array(
                'Orientstruct.structureorientante_id' => array( 'type' => 'select', 'options' => $structsorientantes ),
                'Orientstruct.referentorientant_id' => array( 'type' => 'select', 'options' => $refsorientants, 'selected' => $selected )
            ),
            array(
                'options' => $options
            )
