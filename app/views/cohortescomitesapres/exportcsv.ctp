<?php
    ...
    $csv->addRow( array( 'N° dossier RSA', 'N° CAF', 'Nom/Prénom allocataire', 'Commune de l\'allocataire',  'Date demande APRE', 'Décision du comité', 'Date de décision', 'Montant attribué', 'Observations' ) );
    ...
    foreach( $decisionscomites as $decisioncomite ) {
        ...
        $row = array(
            ...
            $locale->date( 'Date::short', Set::classicExtract( $decisioncomite, 'Comiteapre.datecomite' ) ),
