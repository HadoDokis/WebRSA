    ...
    <fieldset>
        <legend>Recherche de CUI</legend>
            ...
            <fieldset>
                ...
                ?>
                <?php echo $form->input( 'Filtre.datecontrat_from', array( 'label' => 'Du (inclus)', 'type' => 'date', 'dateFormat' => 'DMY', 'maxYear' => date( 'Y' ), 'minYear' => date( 'Y' ) - 120, 'selected' => $datecontrat_from ) );?>
                <?php echo $form->input( 'Filtre.datecontrat_to', array( 'label' => 'Au (exclus)', 'type' => 'date', 'dateFormat' => 'DMY', 'maxYear' => date( 'Y' ) + 5, 'minYear' => date( 'Y' ) - 120, 'selected' => $datecontrat_to ) );?>
            </fieldset>
