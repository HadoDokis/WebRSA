<fieldset>
    <?php echo $form->input( 'Serviceinstructeur.lib_service', array( 'label' =>  __( 'lib_service', true ), 'type' => 'text' ) );?>
    ...
    <?php echo $form->input( 'Serviceinstructeur.code_insee', array( 'label' =>  __( 'code_insee', true ), 'type' => 'text' ) );?>
