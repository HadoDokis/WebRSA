...
<fieldset>
    <legend> CONTRATS D'INSERTION </legend>
            <?php echo $form->input( 'Contratinsertion.forme_ci', array( 'label' => false, 'type' => 'radio' , 'options' => array( 'S' => 'Simple', 'C' => 'Complexe' ), 'legend' => required( __d( 'contratinsertion', 'Contratinsertion.forme_ci', true ) ) ) );?>
        ...
        <?php echo $form->input( 'Contratinsertion.duree_engag', array( 'label' => required( __d( 'contratinsertion', 'Contratinsertion.duree_engag', true ) ), 'type' => 'select', 'options' => $duree_engag, 'empty' => true )  ); ?>
        ...
        <?php echo $form->input( 'Contratinsertion.df_ci', array( 'label' => required( __d( 'contratinsertion', 'Contratinsertion.df_ci', true ) ), 'type' => 'date', 'dateFormat'=>'DMY', 'maxYear'=>date('Y')+10, 'minYear'=>date('Y')-10 , 'empty' => true/*, 'value' => $new_date*/ ) ) ;?>
</fieldset>
<fieldset >
    ...
    <?php endif;?>
        ...
        <?php echo $form->input( 'Contratinsertion.diplomes', array( 'label' => required( __d( 'contratinsertion', 'Contratinsertion.diplomes', true ) ), 'type' => 'textarea', 'rows' => 3)  ); ?>
...
<fieldset>
        ...
        <?php echo $form->input( 'Contratinsertion.service_soutien', array( 'label' => '<em>'.__d( 'contratinsertion', 'Contratinsertion.service_soutien', true ).'</em>', 'type' => 'textarea', 'rows' => 3 )  ); ?>
        ...
        <?php echo $form->input( 'Contratinsertion.pers_charg_suivi', array( 'label' => '<em>'. __d( 'contratinsertion', 'Contratinsertion.pers_charg_suivi', true ).'</em>', 'type' => 'textarea', 'rows' => 1 )  ); ?>