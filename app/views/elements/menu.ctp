					...
					<li><a href="#">Thématiques</a>
						<ul>
							...
							<?php elseif( Configure::read( 'Cg.departement' ) == 58 ):?>
								<li><?php echo $xhtml->link( 'Sélection des allocataires radiés de Pôle Emploi', array( 'controller' => 'sanctionseps', 'action' => 'selectionradies' ) );?></li>
								<li><?php echo $xhtml->link( 'Sélection des allocataires non inscrits à Pôle Emploi', array( 'controller' => 'sanctionseps', 'action' => 'selectionnoninscrits' ) );?></li>
							<?php endif;?>
						</ul>
					</li>
				</ul>
