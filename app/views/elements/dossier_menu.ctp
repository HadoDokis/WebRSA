...
<div class="treemenu">
		...
		<h2 >
			...
			<?php
				...
				$gestionanomaliebdd->foyerErreursPrestationsAllocataires( $dossier ).
				$gestionanomaliebdd->foyerPersonnesSansPrestation( $dossier );
			?>
		</h2>
									...
									<li><span>Droit</span>
										<ul>
											...
											<?php } elseif (Configure::read( 'nom_form_ci_cg' ) == 'cg66' ) { ?>
												...
												<?php endif;?>
												<?php if( $permissions->check( 'traitementspcgs66', 'index' ) ):?>
													<li>
														<?php
															echo $xhtml->link(
																'Traitements PCG',
...
// 															);
											...
											<?php if( $permissions->check( 'historiqueemplois', 'index' ) && Configure::read( 'Cg.departement' ) == 93 ):?>
											<li>
												<?php
													echo $xhtml->link(
														__d( 'historiqueemploi', 'Historiqueemplois::index', true ),
		...
		<li><span>Informations foyer</span>
			<ul>
				...
				<?php if( $permissions->check( 'evenements', 'index' ) ):?>
					<li>
						<?php
							echo $xhtml->link(
								'Evènements',
		...
		<?php if( $permissions->check( 'dossierspcgs66', 'view' ) && Configure::read( 'Cg.departement' ) == 66 ):?>
			<?php
				echo '<li>'.$xhtml->link(
					'Dossier PCG',
		...
		<?php if( $permissions->check( 'dossiers', 'edit' ) ):?>
			<?php
				echo '<li>'.$xhtml->link(
