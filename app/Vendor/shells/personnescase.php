<?php
	class PersonnescaseShell extends Shell
	{
		...
		*/
		...
		public function cleanRecords( $table, $personneAppliId, $personneXmlId ) {
			$success = true;
