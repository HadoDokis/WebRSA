<?php
	class Cohortecui extends AppModel
	{
		...
		*/
		...
		public function search( $statutValidation, $mesCodesInsee, $filtre_zone_geo, $criterescui, $lockedDossiers ) {
			/// Conditions de base
			...
			if( $criterescui['Dossier']['dernier'] ) {
			...
			$etatdossier = Set::extract( $criterescui, 'Situationdossierrsa.etatdosrsa' );
			if( isset( $criterescui['Situationdossierrsa']['etatdosrsa'] ) && !empty( $criterescui['Situationdossierrsa']['etatdosrsa'] ) ) {
