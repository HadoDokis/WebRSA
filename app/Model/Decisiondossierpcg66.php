...
// 				),
        ...
        foreach ($personnesfoyerpcg as $personnefoyerpcg) {
            ...
            $personnespcgs66_situationspdos = $this->Dossierpcg66->Personnepcg66->Personnepcg66Situationpdo->find(
                ...
                'fields' => array_merge(
                        $this->Dossierpcg66->Personnepcg66->Personnepcg66Situationpdo->fields(), $this->Dossierpcg66->Personnepcg66->Personnepcg66Situationpdo->Situationpdo->fields()
                )
                    )
            );
            ...
            $personnespcgs66_statutspdos = $this->Dossierpcg66->Personnepcg66->Personnepcg66Statutpdo->find(
                ...
                'fields' => array_merge(
                        $this->Dossierpcg66->Personnepcg66->Personnepcg66Statutpdo->fields(), $this->Dossierpcg66->Personnepcg66->Personnepcg66Statutpdo->Statutpdo->fields()
                )
                    )
            );
