		...
		**/
		...
		public function updateEtatDossierViaTraitement( $traitementpcg66_id ) {
            $traitementpcg66 = $this->Personnepcg66->Traitementpcg66->find(
				...
				array(
                    'fields' => array_merge(
                        $this->Personnepcg66->Traitementpcg66->fields(),
                        $this->Personnepcg66->Traitementpcg66->Personnepcg66->fields(),
                        $this->Personnepcg66->Traitementpcg66->Personnepcg66->Dossierpcg66->fields(),
                        $this->Personnepcg66->Traitementpcg66->Personnepcg66->Dossierpcg66->Decisiondossierpcg66->fields()
                    ),
					'conditions' => array(
						'Traitementpcg66.id' => $traitementpcg66_id
					),
