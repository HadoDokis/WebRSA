<?php
	/**
	 * Code source de la classe WebrsaCohorteApre66.
	 *
	 * PHP 5.3
	 *
	 * @package app.Model
	...
	/**
	 * La classe WebrsaCohorteApre66 ...
	 *
	 * @package app.Model
	 */
	class WebrsaCohorteApre66 extends AbstractWebrsaCohorte
	{
		/**
		 * Nom du modèle.
		 *
		 * @var string
		 */
		public $name = 'WebrsaCohorteApre66';
