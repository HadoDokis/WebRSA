<?php
	...
	class Nonorientationprocov58 extends AbstractThematiquecov58
	{
		...
		/**
		 * Retourne le document PDF de décision de la COV pour la thématique.
		 *
		...
		/*public function getPdfDecision( $passagecov58_id ) {
			...
			$query = array(
				...
				'conditions' => array(
					...
					'OR' => array(
						...
						'Adressefoyer.id IN ('.$Adressefoyer->sqDerniereRgadr01('Adressefoyer.foyer_id').')'
					)
				),
				'joins' => array(
					$this->Dossiercov58->Passagecov58->join( 'Dossiercov58' ),
			...
			$fileName = "decision_{$data['Decisionnonorientationprocov58']['decisioncov']}.odt";
