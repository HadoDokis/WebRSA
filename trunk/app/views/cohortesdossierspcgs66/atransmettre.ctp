...
<?php echo $xform->create( 'Cohortedossierpcg66', array( 'type' => 'post', 'action' => 'atransmettre', 'id' => 'Search', 'class' => ( ( is_array( $this->data ) && !empty( $this->data ) ) ? 'folded' : 'unfolded' ) ) );?>
...
<?php echo $pagination;?>
<?php echo $form->create( 'Dossierpcg66Atransmettre', array( 'url'=> Router::url( null, true ) ) );?>
	<?php
