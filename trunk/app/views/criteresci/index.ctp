...
<?php echo $form->create( 'Critereci', array( 'type' => 'post', 'action' => '/index/', 'id' => 'Search', 'class' => ( ( is_array( $this->data ) && !empty( $this->data ) ) ? 'folded' : 'unfolded' ) ) );?>
    ...
    <fieldset>
        <legend>Recherche par CER</legend>
            ...
            <?php echo $form->input( 'Filtre.forme_ci', array( 'label' => false, 'type' => 'radio', 'options' => $forme_ci /*array( 'S' => 'Simple', 'C' => 'Complexe' )*/, 'legend' => 'Forme du contrat', 'default' => 'S' ) ); ?>
            ...
            <fieldset>
                ...
                <?php echo $form->input( 'Filtre.date_saisi_ci_to', array( 'label' => 'Au', 'type' => 'date', 'dateFormat' => 'DMY', 'maxYear' => date( 'Y' ), 'minYear' => date( 'Y' ) - 120,  'maxYear' => date( 'Y' ) + 5, 'selected' => $date_saisi_ci_to ) );?>
            </fieldset>
