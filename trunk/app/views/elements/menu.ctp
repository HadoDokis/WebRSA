    ...
    <ul>
        <?php if( $session->check( 'Auth.User' ) ): ?>
            ...
            <li onmouseover="$(this).addClassName( 'hover' );" onmouseout="$(this).removeClassName( 'hover' );">
                ...
                <ul>
                    <li><?php echo $html->link( 'Nouvelles demandes', array( 'controller' => 'cohortes', 'action' => 'index', 'Non orienté' ) );?></li>
                    <li><?php echo $html->link( 'Demandes orientées', array( 'controller' => 'cohortes', 'action' => 'index', 'Orienté' ) );?></li>
                    <li><?php echo $html->link( 'Demandes en attente', array( 'controller' => 'cohortes', 'action' => 'index', 'En attente' ) );?></li>
