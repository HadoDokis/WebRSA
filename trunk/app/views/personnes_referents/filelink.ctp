...
<div class="with_treemenu">
    <?php
        ...
        echo $form->create( 'PersonneReferent', array( 'type' => 'post', 'id' => 'personnereferentform', 'url' => Router::url( null, true ) ) );
    ?>
        <fieldset>
    <legend><?php echo required( $default2->label( 'PersonneReferent.haspiecejointe' ) );?></legend>

    <?php echo $form->input( 'PersonneReferent.haspiecejointe', array( 'type' => 'radio', 'options' => $options['haspiecejointe'], 'legend' => false, 'fieldset' => false ) );?>
...
<script type="text/javascript">
    document.observe( "dom:loaded", function() {
        observeDisableFieldsetOnRadioValue(
            'personnereferentform',
            'data[PersonneReferent][haspiecejointe]',
...
<?php
        ...
        if( !empty( $personneReferent['Fichiermodule'] ) ){
            $fichiersLies = Set::extract( $personneReferent, 'PersonneReferent/Fichiermodule' );
