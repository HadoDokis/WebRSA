...
// debug( $dossierep );
		echo $xhtml->tableCells(
			array(
				...
				isset( $options['Decisionradiepoleemploiep58']['decision'][$dossierep['Radiepoleemploiep58']['Decisionradiepoleemploiep58'][1]['decision']] ) ? $options['Decisionradiepoleemploiep58']['decision'][$dossierep['Radiepoleemploiep58']['Decisionradiepoleemploiep58'][1]['decision']] : $options['Decisionradiepoleemploiep58']['decision'][$dossierep['Radiepoleemploiep58']['Decisionradiepoleemploiep58'][0]['decision']],
				...
				$form->input( "Decisionradiepoleemploiep58.{$i}.etape", array( 'type' => 'hidden', 'value' => 'cg' ) ).
