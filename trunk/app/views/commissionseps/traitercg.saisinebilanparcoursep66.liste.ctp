...
$typeorientemploiId = $typeorientprincipale['Emploi'][0];
	foreach( $dossiers[$theme]['liste'] as $i => $dossierep ) {
		...
		$hiddenFields = 
						$form->input( "Bilanparcours66.{$i}.parenttypeorient_id", array( 'type' => 'hidden', 'value' => $dossierep['Saisinebilanparcoursep66']['Bilanparcours66']['Orientstruct']['Typeorient']['parentid'] ) ).
		...
		$typesorientsprincipales =
			$xhtml->tag(
				'div',
				$xform->input( "Decisionsaisinebilanparcoursep66.{$i}.typeorientprincipale_id", array( 'div' => false, 'label' => false, 'options' => $options['Saisinebilanparcoursep66']['typeorientprincipale_id'], 'empty' => true ) )
		);
		...
		echo $xhtml->tableCells(
			array(
				...
				array(
					$form->input( "Decisionsaisinebilanparcoursep66.{$i}.typeorient_id", array( 'label' => false, 'options' => $options['Saisinebilanparcoursep66']['typeorient_id'], 'empty' => true ) ),
