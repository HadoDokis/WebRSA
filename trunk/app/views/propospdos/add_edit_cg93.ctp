...
//             echo $xform->input( 'PropopdoTypenotifpdo.id', array( 'type' => 'hidden' ) );
    ...
    <div class="aere">
        <fieldset>
            ...
            <?php
                echo $xform->input( 'Propopdo.structurereferente_id', array( 'label' =>  ( __( 'Structure gérant la PDO', true ) ), 'type' => 'select', 'options' => $structs, 'empty' => true ) );
                ...
                echo $xform->input( 'Propopdo.decision', array( 'type' => 'hidden', 'value' => '1' ) ).$xform->input( 'Propopdo.decisionpdo_id', array( 'label' =>  ( __( 'Décision du Conseil Général', true ) ), 'type' => 'select', 'options' => $decisionpdo, 'empty' => true ) );
