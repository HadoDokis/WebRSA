...
<?php $this->pageTitle = 'Liste des candidatures';?>
         ...
         <table class="tooltips_oupas">
            ...
            <tbody>
                <tr class="odd dynamic" id="innerTableTrigger0">
                    ...
                    <td>01/06/2009</td>
                    <td>Oui</td>
                    <td><a href="../webrsa/traitement_candidature" title=""><img src="suivi_stagiaires_fichiers/disk.png"> Traitement candidature</a></td>
                </tr>
