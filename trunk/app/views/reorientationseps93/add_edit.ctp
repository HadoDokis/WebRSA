		...
		<?php
			...
			echo $default->subform(
				array(
					...
					'Reorientationep93.typeorient_id' => array( 'label' => 'Type d\'orientation', 'required' => true ),
					'Reorientationep93.structurereferente_id' => array( 'label' => 'Type de structure' ),
					'Reorientationep93.referent_id' => array( 'label' => 'Nom du référent' ),
			...
			echo $default->subform( array( 'Reorientationep93.datedemande' => array( 'maxYear' => date( 'Y' ) + 1, 'minYear' => date( 'Y' ) - 1 ) ) );
