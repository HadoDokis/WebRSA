		...
		echo $default2->index(
			...
			array(
				'actions' => array(
					...
					'Rendezvous::edit' => array( 'disabled' => '( "'.$permissions->check( 'rendezvous', 'edit' ).'" != "1" ) || ( "#Rendezvous.id#" != '.$lastrdv_id.' ) || ( "'.$dossierepEnCours.'" == "1" )' ),
					'Rendezvous::print' => array( 'label' => 'Imprimer', 'url' => array( 'action' => 'gedooo' ), 'disabled' =>  '( "'.$permissions->check( 'rendezvous', 'print' ).'" != "1" ) '  ),
					'Rendezvous::delete' => array( 'disabled' => '( "'.$permissions->check( 'rendezvous', 'delete' ).'" != "1" ) || ( "#Rendezvous.id#" != '.$lastrdv_id.' ) || ( "'.$dossierepEnCours.'" == "1" )' ),
