...
<fieldset>
    ...
    <?php
        ...
        echo $ajax->observeField( 'Aideapre66Typeaideapre66Id', $ajaxOptions );
                    ...
                    foreach( $listesAidesSelonApre as $i => $liste ){
                        ...
                        echo $xhtml->tableCells(
                            array(
                                ...
                                h( $locale->money( Set::classicExtract( $liste, 'Aideapre66.montantaccorde' ) ) ),
                            )
                        );
                    }
                ?>
...
<fieldset id="Hasfrais">
    ...
    <?php
        ...
        echo $xform->input( 'Fraisdeplacement66.destination', array( 'label' => __d( 'fraisdeplacement66', "Fraisdeplacement66.destination", true ), 'type' => 'text', 'required' => true ) );
    ?>
