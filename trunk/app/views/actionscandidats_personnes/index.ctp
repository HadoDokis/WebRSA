            ...
            echo $default2->index(
                ...
                array(
                    ...
                    'actions' => array(
                        ...
                        'ActionscandidatsPersonnes::cancel' => array( 'domain' => $domain, 'disabled' =>  '( "'.$permissions->check( 'actionscandidats_personnes', 'cancel' ).'" != "1" ) || ( "#ActioncandidatPersonne.positionfiche#" == "annule" ) '  ),
