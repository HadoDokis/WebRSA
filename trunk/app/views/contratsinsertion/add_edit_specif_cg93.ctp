...
<fieldset>
	...
	<table class="wide noborder">
		...
		<tr>
			<td class="mediumSize noborder">
				<strong><?php echo __d( 'foyer', 'Foyer.sitfam', true ); ?> : </strong>
			</td>
			<td class="mediumSize noborder">
				<?php echo $xform->input( 'Contratinsertion.sitfam', array( 'label' => false, 'options' => $sitfam, 'empty' => true ) ); ?>
			</td>
		</tr>
		<tr>
			<td class="mediumSize noborder">
				<strong><?php echo __d( 'foyer', 'Foyer.typeocclog', true ); ?> : </strong>
			</td>
			<td class="mediumSize noborder">
				<?php echo $xform->input( 'Contratinsertion.typeocclog', array( 'label' => false, 'options' => $typeocclog, 'empty' => true ) ); ?>
			</td>
		</tr>
		<tr>
			<td class="mediumSize noborder">
				<strong><?php echo __d( 'contratinsertion', 'Contratinsertion.cmu', true ); ?> : </strong>
			</td>
			<td class="mediumSize noborder">
				<?php echo $xform->input( 'Contratinsertion.cmu', array( 'label' => false, 'options' => $options['Contratinsertion']['cmu'], 'type' => 'radio' ) ); ?>
			</td>
		</tr>
		<tr>
			<td class="mediumSize noborder">
				<strong><?php echo __d( 'contratinsertion', 'Contratinsertion.cmuc', true ); ?> : </strong>
			</td>
			<td class="mediumSize noborder">
				<?php echo $xform->input( 'Contratinsertion.cmuc', array( 'label' => false, 'options' => $options['Contratinsertion']['cmuc'], 'type' => 'radio' ) ); ?>
			</td>
		</tr>
		<tr>
			<td class="mediumSize noborder">
				<strong><?php echo __d( 'contratinsertion', 'Contratinsertion.persacharge', true ); ?> : </strong>
			</td>
			<td class="mediumSize noborder">
				<?php echo $xform->input( 'Contratinsertion.persacharge', array( 'label' => false, 'type' => 'textarea' ) ); ?>
			</td>
		</tr>
	</table>
</fieldset>
...
<fieldset >
	...
	<?php
		echo $form->input( 'Dsp.id', array( 'label' => false, 'div' => false,  'type' => 'hidden' ) );
		echo $form->input( 'Dsp.personne_id', array( 'label' => false, 'div' => false, 'type' => 'hidden' ) );
		echo $form->input( 'Dsp.nivetu', array( 'label' => __d( 'dsp', 'Dsp.nivetu', true ), 'options' => $nivetus, 'empty' => true ) );
		echo $form->input( 'Contratinsertion.diplomes', array( 'label' => __d( 'contratinsertion', 'Contratinsertion.diplomes', true ), 'type' => 'textarea', 'rows' => 3)  ); 
		echo $form->input( 'Contratinsertion.expr_prof', array( 'label' => __d( 'contratinsertion', 'Contratinsertion.expr_prof', true ), 'type' => 'textarea', 'rows' => 3 )  );
		echo $form->input( 'Contratinsertion.form_compl', array( 'label' => __d( 'contratinsertion', 'Contratinsertion.form_compl', true ), 'type' => 'textarea', 'rows' => 3 )  );
	?>
	<fieldset>
		...
		<?php
			echo $form->input( 'Contratinsertion.sect_acti_emp', array( 'label' => required( __d( 'contratinsertion', 'Contratinsertion.sect_acti_emp', true ) ), 'type' => 'select', 'options' => $sect_acti_emp, 'empty' => true ) );
			echo $form->input( 'Contratinsertion.emp_occupe', array( 'label' => required( __d( 'contratinsertion', 'Contratinsertion.emp_occupe', true ) ), 'type' => 'select', 'options' => $emp_occupe, 'empty' => true ) );
			echo $form->input( 'Contratinsertion.duree_hebdo_emp', array( 'label' => required( __d( 'contratinsertion', 'Contratinsertion.duree_hebdo_emp', true ) ), 'type' => 'select', 'options' => $duree_hebdo_emp, 'empty' => true ) );
			echo $form->input( 'Contratinsertion.nat_cont_trav', array( 'label' => required( __d( 'contratinsertion', 'Contratinsertion.nat_cont_trav', true ) ), 'type' => 'select', 'options' => $nat_cont_trav, 'empty' => true ) );
			echo $form->input( 'Contratinsertion.duree_cdd', array( 'label' => required( __d( 'contratinsertion', 'Contratinsertion.duree_cdd', true ) ), 'type' => 'select', 'options' => $duree_cdd, 'empty' => true ) );
		?>
	</fieldset>
</fieldset>
...
<fieldset>
	<legend> PROJET DE CE NOUVEAU CONTRAT</legend>
		<?php
			echo $form->input( 'Contratinsertion.objectifs_fixes', array( 'label' => __d( 'contratinsertion', 'Contratinsertion.objectifs_fixes', true ), 'type' => 'textarea', 'rows' => 3 ) );
 			echo $form->input( 'Contratinsertion.dd_ci', array( 'label' => required( __d( 'contratinsertion', 'Contratinsertion.dd_ci', true ) ), 'type' => 'date', 'dateFormat' => 'DMY', 'maxYear' => date('Y')+10, 'minYear' => date('Y')-10 , 'empty' => true ) );
 			echo $form->input( 'Contratinsertion.duree_engag', array( 'label' => required( __d( 'contratinsertion', 'Contratinsertion.duree_engag', true ) ), 'type' => 'select', 'options' => $duree_engag_cg93, 'empty' => true ) );
 			echo $form->input( 'Contratinsertion.df_ci', array( 'label' => required( __d( 'contratinsertion', 'Contratinsertion.df_ci', true ) ), 'type' => 'date', 'dateFormat' => 'DMY', 'maxYear' => date('Y')+10, 'minYear' => date('Y')-10 , 'empty' => true ) );
		?>
</fieldset>
...
<script type="text/javascript">
	document.observe( "dom:loaded", function() {
		...
		$( 'ContratinsertionEmpTrouvO' ).observe( 'change', function( event ) {
