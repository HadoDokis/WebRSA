			...
			<legend> PARTIE RESERVEE AU DEPARTEMENT</legend>
				...
				<?php
					if( Configure::read( 'Cg.departement' ) == 66 ) {
						echo $form->input( 'Contratinsertion.datedecision', array( 'label' => '', 'type' => 'date', 'dateFormat'=>'DMY', 'maxYear'=>date('Y')+5, 'minYear'=>date('Y')-1 , 'empty' => true)  );
					}
					else{
						echo $form->input( 'Contratinsertion.datevalidation_ci', array( 'label' => '', 'type' => 'date', 'dateFormat'=>'DMY', 'maxYear'=>date('Y')+5, 'minYear'=>date('Y')-1 , 'empty' => true)  );
					}
				?>
				<br />
