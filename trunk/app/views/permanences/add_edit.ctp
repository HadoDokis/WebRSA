...
?>
    ...
    <fieldset>
        ...
        <?php echo $form->input( 'Permanence.numvoie', array( 'label' =>  __( 'numvoie', true ), 'type' => 'text', 'maxlength' => 15 ) );?>
        ...
        <?php echo $form->input( 'Permanence.compladr', array( 'label' =>  __( 'compladr', true ), 'type' => 'text', 'maxlength' => 50 ) );?>
