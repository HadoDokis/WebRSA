<?php
	...
	{
		public $uses = array( 'Dossier', 'Foyer', 'Personne', 'Ressource', 'Ressourcemensuelle' );
		public $_xmlFile;
		public $_xmlParser;
		public $_xmlString = '';
		...
		public function processDemandeRsa( $demandeXmlString ) {
		...
		public function startElement( $xmlParser, $currentTagName, $attrs ) {
		...
		public function cdataElement( $xmlParser, $data ) {
			$data = trim( $data );
			if( !empty( $data ) ) {
		...
		public function endElement( $xmlParser, $currentTagName ) {
			$currentTagName = strtolower( $currentTagName );
