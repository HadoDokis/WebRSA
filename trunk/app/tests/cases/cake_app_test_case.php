	...
	class CakeAppTestCase extends CakeTestCase {
		...
		*/
		...
		public $fixtures = array (
			...
			'app.personne',
			'app.dsp',
			'app.decisionnonorientationproep66',
			...
			'app.permanence',
			'app.condadmin',
			'app.decisionsaisinebilanparcoursep66',
			'app.historiqueetatpe',
			'app.pieceformqualif',
			'app.decisionsaisinepdoep66',
			'app.formqualif',
			'app.dossierep',
			'app.aideagricole',
			'app.detailconfort',
