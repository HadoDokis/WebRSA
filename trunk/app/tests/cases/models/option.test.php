<?php
	...
	class OptionTestCase extends CakeAppModelTestCase {


		function testAbaneu() {
			$result = $this->Option->abaneu();
			$expected = array(
				'A' => 'Abattement',
				'N' => 'Neutralisation'
			);
		...
		function testAccosocfam() {
			$result = $this->Option->accosocfam();
			$expected = array(
				'O' => 'Oui',
				'N' => 'Non',
				'P' => 'Pas de réponse'
		...
		function testApplieme() {
			$result = $this->Option->applieme();
			$expected = array(
				'CRI' => 'Cristal Cnaf',
				'AGO' => 'Agora Ccmsa',
				'NRI' => '@IRMI Cnaf',
		...
		function testAutorutiadrelec() {
			$result = $this->Option->autorutiadrelec();
			$expected = array(
		...
		function testAutorutitel() {
			$result = $this->Option->autorutitel();
			$expected = array(
				'A' => 'Accord d\'utilisation',
				'I' => 'Inconnu',
				'R' => 'Refus d\'utilisation'
		...
		function testAviscondadmrsa() {
			$result = $this->Option->aviscondadmrsa();
			$expected = array(
		...
		function testAvisdero() {
			$result = $this->Option->avisdero();
			$expected = array(
				'D' => 'Avis demandé au CG',
				'O' => 'Accord du CG',
				'N' => 'Refus du CG',
		...
		function testAvisdestpairsa() {
			$result = $this->Option->Avisdestpairsa();
			$expected = array(
				'D' => 'Avis demandé au CG',
				'A' => 'Accord du CG',
				'R' => 'Refus du CG'
		...
		function testAviseqpluri() {
			$result = $this->Option->aviseqpluri();
			$expected = array(
				'R' => 'Réorientation',
		...
		function testAvisraison_ci() {
			$result = $this->Option->avisraison_ci();
			$expected = array(
		...
		function testCommission() { ///FIXME: ajout pour les PDO mais à voir
			$result = $this->Option->commission();
			$expected = array(
		...
		function testCouvsoc() {
			$result = $this->Option->couvsoc();
			$expected = array(
				'O' => 'Oui',
				'N' => 'Non',
				'P' => 'Pas de réponse'
		...
		function testCreareprisentrrech() {
			$result = $this->Option->creareprisentrrech();
			$expected = array(
				'O' => 'Oui',
				'N' => 'Non',
				'P' => 'Pas de réponse'
		...
		function testDecisionpdo() {
			$result = $this->Option->decisionpdo();
			$expected = array(
		...
		function testDecisionrecours() {
			$result = $this->Option->decisionrecours();
			$expected = array(
				'P' => 'Pas de décision',
				'A' => 'Accord',
				'R' => 'Refus',
		...
		function testDecision_ci() {
			$result = $this->Option->decision_ci();
			$expected = array(
		...
		function testDemarlog() {
			$result = $this->Option->demarlog();
			$expected = array(
		...
		function testDomideract(){
			$result = $this->Option->domideract();
			$expected = array(
				'O' => 'Oui',
				'N' => 'Non',
				'P' => 'Pas de réponse'
		...
		function testDrorsarmiant(){
			$result = $this->Option->drorsarmiant();
			$expected = array(
				'O' => 'Oui',
				'N' => 'Non',
				'P' => 'Pas de réponse'
		...
		function testDrorsarmianta2(){
			$result = $this->Option->drorsarmianta2();
			$expected = array(
				'O' => 'Oui',
				'N' => 'Non',
				'P' => 'Pas de réponse'
		...
		function testDuractdomi() {
			$result = $this->Option->duractdomi();
			$expected = array(
				'2104' => 'Moins d\'un an',
				'2105' => 'De 1 à 3 ans',
				'2106' => 'De 4 à 6 ans',
		...
		function testDuree_engag_cg58() {
			$result = $this->Option->duree_engag_cg58();
			$expected = array(
				'1' => '3 mois',
				'2' => '6 mois',
				'3' => '9 mois',
		...
		function testDuree_engag_cg66() {
			$result = $this->Option->duree_engag_cg66();
			$expected = array(
				'1' => '3 mois',
				'2' => '6 mois',
				'3' => '9 mois',
		...
		function testDuree_engag_cg93() {
			$result = $this->Option->duree_engag_cg93();
			$expected = array(
				'1' => '3 mois',
				'2' => '6 mois',
				'3' => '9 mois',
		...
		function testDuree_cdd() {
			$result = $this->Option->duree_cdd();
			$expected = array(
				'DT1' => 'Temps plein',
				'DT2' => 'Temps partiel',
				'DT3' => 'Mi-temps'
		...
		function testDuree_hebdo_emp() {
			$result = $this->Option->duree_hebdo_emp();
			$expected = array(
				'DHT1' => 'Moins de 35h',
				'DHT2' => '35h',
		...
		function testElopersdifdisp() {
			$result = $this->Option->elopersdifdisp();
			$expected = array(
				'O' => 'Oui',
				'N' => 'Non',
				'P' => 'Pas de réponse'
		...
		function testEngproccrealim() {
			$result = $this->Option->engproccrealim();
			$expected = array(
				'O' => 'Procédure engagée',
		...
		function testEmp_occupe() {
			$result = $this->Option->emp_occupe();
			$expected = array(
		...
		function testEtatcrealim() {
			$result = $this->Option->etatcrealim();
			$expected = array(
		...
		function testEtatdosrsa() {
			$result = $this->Option->etatdosrsa();
			$expected = array(
				'Z' => 'Non défini',
		...
		function testSuiirsa() {
			$result = $this->Option->suiirsa();
			$expected = array(
		...
		function testFonction_pers() {
			$result = $this->Option->fonction_pers();
			$expected = array(
				'ADM' => 'Administrateur',
				'VAL' => 'Validateur',
				'AGE' => 'Agent simple'
		...
		function testFormeci() {
			$result = $this->Option->formeci();
			$expected = array(
				'S' => 'Simple',
				'C' => 'Complexe'
			);
		...
		function testlib_action() {
			$result = $this->Option->Lib_action();
			$expected = array(
				'A' => 'Aide',
				'P' => 'Prestation'
			);
		...
		function testLib_struc() {
			$result = $this->Option->lib_struc();
			$expected = array(
				'1' => 'Pole emploi',
				'2' => 'Assedic'
			);
		...
		function testMatetel() {
			$result = $this->Option->matetel();
			$expected = array(
				'FAX' => 'Fax seul',
				'TEL' => 'Téléphone seul',
				'TFA' => 'Téléphone/Fax'
		...
		function testMoticlorsa() {
			$result = $this->Option->moticlorsa();
			$expected = array(
		...
		function testMotidiscrealim() {
			$result = $this->Option->motidiscrealim();
			$expected = array(
		...
		function testMotifpdo() { ///FIXME: ajout pour les PDO mais à voir
			$result = $this->Option->motifpdo();
			$expected = array(
		...
		function testMotidempdo() { ///FIXME: ajout pour les PDO mais à voir
			$result = $this->Option->motidempdo();
			$expected = array(
		...
		function testMotidemrsa() {
			$result = $this->Option->motidemrsa();
			$expected = array(
		...
		function testMotisusdrorsa() {
			$result = $this->Option->motisusdrorsa();
			$expected = array(
		...
		function testMotisusversrsa() {
			$result = $this->Option->motisusversrsa();
			$expected = array(
		...
		function testNat_cont_trav() {
			$result = $this->Option->nat_cont_trav();
			$expected = array(
...
/*
		function testmotisusdrorsa*/
		function testNationalite() {
			$result = $this->Option->nationalite();
			$expected = array(
				'A' => 'Autre nationalité',
		...
		function testNatpfcre() {
			$result = $this->Option->natpfcre(null);
			$this->assertTrue($result);			
		}

		function testNatress() {
			$result = $this->Option->natress();
			$expected = array(
		...
		function testNatfingro() {
			$result = $this->Option->natfingro();
			$expected = array(
		...
		//Ajout suite à l'arrivée du RSAJeune
		function testNatgroupfsus() {
			$result = $this->Option->natgroupfsus();
			$expected = array(
		...
		function testNatureAidesApres() {
			$result = $this->Option->natureAidesApres();
			$expected = array(
		...
		function testObstemploidifdisp() {
			$result = $this->Option->obstemploidifdisp();
			$expected = array(
				'O' => 'Oui',
				'N' => 'Non',
				'P' => 'Pas de réponse'
		...
		function testOridemrsa() {
			$result = $this->Option->oridemrsa();
			$expected = array(
		...
		function testOrioblalim() {
			$result = $this->Option->orioblalim();
			$expected = array(
		...
		function testParassoasf() {
			$result = $this->Option->parassoasf();
			$expected = array(
				'P' => 'Père',
				'M' => 'Mère'
			);
		...
		function testPaysact() {
			$result = $this->Option->paysact();
			$expected = array(
				'FRA' => 'France',
				'LUX' => 'Luxembourg',
		...
		function testPieecpres() {
			$result = $this->Option->pieecpres();
			$expected = array(
		...
		function testQuinzaine() {
			$result = $this->Option->quinzaine();
			$expected = array(
		...
		function testRaison_ci() {
			$result = $this->Option->raison_ci();
			$expected = array(
				'S' => 'Suspension',
				'R' => 'Radiation'
			);
		...
		function testRegfisagri() {
			$result = $this->Option->regfisagri();
			$expected = array(
		...
		function testRegfiseti() {
			$result = $this->Option->regfiseti();
			$expected = array(
				'R' => 'Réel',
				'S' => 'Simple',
				'M' => 'Micro'
		...
		function testRegfisetia1() {
			$result = $this->Option->regfisetia1();
			$expected = array(
				'R' => 'Réel',
				'S' => 'Simple',
				'M' => 'Micro'
		...
		function testRolepers( ) {
			$result = $this->Option->rolepers();
			$expected = array(
		...
		function testSect_acti_emp() {
			$result = $this->Option->sect_acti_emp();
			$expected = array(
		...
		function testSensopecompta() {
			$result = $this->Option->sensopecompta();
			$expected = array(
		...
		function testSousnatpf() {
			$result = $this->Option->sousnatpf();
			$expected = array(
	...
	function testStatut_contrat_insertion() {
		...
		function testStatut_orient() {
			$result = $this->Option->statut_orient();
			$expected = array(
		...
		function testStatutrdv() {
			$result = $this->Option->statutrdv();
			$expected = array(
				'P' => 'Prévu',
				'T' => 'Honoré',
				'A' => 'Annulé',
		...
		function testStatutrelance() {
			$result = $this->Option->statutrelance();
			$expected = array(
				'R' => 'Relancé',
				'E' => 'En attente'
			);
		...
		function testTopaccre() {
			$result = $this->Option->topaccre();
			$expected = array(
		...
		function testTopbeneti() {
			$result = $this->Option->Topbeneti();
			$expected = array(
		...
		function testTopdemdisproccrealim() {
			$result = $this->Option->topdemdisproccrealim();
			$expected = array(
		...
		function testTopcreaentre() {
			$result = $this->Option->topcreaentre();
			$expected = array(
		...
		function testTopempl1ax() {
			$result = $this->Option->topempl1ax();
			$expected = array(
		...
		function testTopevoreveti() {
			$result = $this->Option->topevoreveti();
			$expected = array(
		...
		function testTopfoydrodevorsa() {
			$result = $this->Option->topfoydrodevorsa();
			$expected = array(
		...
		function testTopjugpa() {
			$result = $this->Option->topjugpa();
			$expected = array(
		...
		function testToppersdrodevorsa() {
			$result = $this->Option->toppersdrodevorsa();
			$expected = array(
				'' => 'Non défini',
				'1' => 'Oui',
				'0' => 'Non'
		...
		function testTopressevaeti() {
			$result = $this->Option->topressevaeti();
			$expected = array(
		...
		function testTopsansdomfixe() {
			$result = $this->Option->topsansdomfixe();
			$expected = array(
				'0' => 'Domicile fixe',
		...
		function testTopsansempl() {
			$result = $this->Option->topsansempl();
			$expected = array(
				'1' => 'Sans employés',
				'0' => 'Avec employés'
			);
		...
		function testTopstag1ax() {
			$result = $this->Option->topstag1ax();
			$expected = array(
		...
		function testType_allocation() {
			$result = $this->Option->type_allocation();
			$expected = array(
		...
		function testTypedero() {
			$result = $this->Option->typedero();
			$expected = array(
		...
		function testTypeadr() {
			$result = $this->Option->typeadr();
			$expected = array(
				'D' => 'Définitive',
				'P' => 'Provisoire',
		...
		function testTypedtnai() {
			$result = $this->Option->typedtnai();
			$expected = array(
				'J' => 'Jour inconnu',
		...
		function testTypenotifpdo() {
			$result = $this->Option->typenotifpdo();
			$expected = array(
		...
		function testTypeocclog() {
			$result = $this->Option->typeocclog();
			$expected = array(
		...
		function testTypepdo() {
			$result = $this->Option->typepdo();
			$expected = array(
				'N' => 'Non défini',
				'C' => 'PDO de contrôle',
				'M' => 'PDO de maintien',
		...
		function testTypeopecompta() {
			$result = $this->Option->typeopecompta();
			$expected = array(
/*AllocCompta*/
...
/*Autre annulations*/
		...
		function testTypepar() {
			$result = $this->Option->typepar();
			$expected = array(
				'ADP' => 'Adoption simple',
				'ASC' => 'Ascendant',
				'AUT' => 'Autre',
		...
		function testTypeparte() {
			$result = $this->Option->typeparte();
			$expected = array(
		...
		function testTypeperstie() {
			$result = $this->Option->typeperstie();
			$expected = array(
		...
		function testTyperes() {
			$result = $this->Option->typeres();
			$expected = array(
		...
		function testTypeserins() {
			$result = $this->Option->typeserins();
			$expected = array(
				'' => 'Hors département',
				'A' => 'Organisme agréé',
		...
		function testType_totalisation() {
			$result = $this->Option->type_totalisation();
			$expected = array(
//                 'TotalAllocationsComptabilises' => 'Total des allocations comptabilisees',
		...
		function testTypevoie() {
			$result = $this->Option->typevoie();
			$expected = array(
				'ABE' => 'Abbaye',
				'ACH' => 'Ancien chemin',
				'AGL' => 'Agglomération',
		...
		function testTypo_aide() {
			$result = $this->Option->typo_aide();
			$expected = array(
				'1' => 'Insertion sociale',
		...
		function testMotifrecours(){
			$result = $this->Option->motifrecours();
			$expected = array(
				'N' => 'Non admissible',
				'A' => 'Admissible',
				'P' => 'Pièces manquantes'
