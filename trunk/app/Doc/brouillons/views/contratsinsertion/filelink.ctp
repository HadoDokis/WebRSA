...
<div class="with_treemenu">
	<?php
		...
		echo $form->create( 'Contratinsertion', array( 'type' => 'post', 'id' => 'contratinsertionform', 'url' => Router::url( null, true ) ) );
	?>
		<fieldset>
	<legend><?php echo required( $default2->label( 'Contratinsertion.haspiecejointe' ) );?></legend>

	<?php echo $form->input( 'Contratinsertion.haspiecejointe', array( 'type' => 'radio', 'options' => $options['haspiecejointe'], 'legend' => false, 'fieldset' => false ) );?>
...
<script type="text/javascript">
	document.observe( "dom:loaded", function() {
		observeDisableFieldsetOnRadioValue(
			'contratinsertionform',
			'data[Contratinsertion][haspiecejointe]',
...
<?php
		...
		echo $fileuploader->results( Set::classicExtract( $contratinsertion, 'Fichiermodule' ) );
	?>
</div>
	<div class="submit">
		<?php
