		...
		<fieldset id="avismne">
			<legend><?php echo 'Avis MNE';?></legend>
				<?php
					...
					echo $this->Xform->input( 'Propodecisioncui66.datepropositioncui', array( 'label' => __d( 'propodecisioncui66', 'Propodecisioncui66.datepropositioncui' ), 'type' => 'date', 'dateFormat'=>'DMY', 'maxYear'=>date('Y')+2, 'minYear'=>date('Y')-2 , 'empty' => true)  );
				?>
		</fieldset>
			...
			<fieldset id="aviselu">
				<legend></legend>
					<?php
						...
						echo $this->Xform->input( 'Propodecisioncui66.datepropositioncuielu', array( 'label' => __d( 'propodecisioncui66', 'Propodecisioncui66.datepropositioncuielu' ), 'type' => 'date', 'dateFormat'=>'DMY', 'maxYear'=>date('Y')+2, 'minYear'=>date('Y')-2 , 'empty' => true)  );
					?>
			</fieldset>
		</fieldset>
			...
			<fieldset id="avisreferent">
				<legend></legend>
					<?php
						...
						echo $this->Xform->input( 'Propodecisioncui66.datepropositioncuireferent', array( 'label' => __d( 'propodecisioncui66', 'Propodecisioncui66.datepropositioncuireferent' ), 'type' => 'date', 'dateFormat'=>'DMY', 'maxYear'=>date('Y')+2, 'minYear'=>date('Y')-2 , 'empty' => true)  );
					?>
			</fieldset>
		</fieldset>
	<div class="submit">
