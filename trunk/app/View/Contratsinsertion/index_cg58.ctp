						...
						echo $this->Xhtml->tableCells(
							array(
								...
								$this->Xhtml->editLink(
									...
									!$block
									&& $this->Permissions->check( 'contratsinsertion', 'edit' )
								),
								...
								$this->Xhtml->avenantLink(
									...
									$this->Permissions->check( 'contratsinsertion', 'add' )
