...
?>
<?php echo $this->Form->create( 'Statistiquesministerielle', array( 'type' => 'post', 'action' => '/indicateursOrganismes/', 'id' => 'Search', 'class' => ( !empty( $this->request->data ) ? 'folded' : 'unfolded' ) ) );?>
