...
<fieldset>
	<legend>Recherche par date de décision</legend>
		...
		<fieldset>
			...
			<?php echo $this->Form->input( 'Propopdo.datereceptionpdo_to', array( 'label' => 'Au (exclus)', 'type' => 'date', 'dateFormat' => 'DMY', 'maxYear' => date( 'Y' ), 'minYear' => date( 'Y' ) - 120, 'maxYear' => date( 'Y' ) + 5,  'selected' => $datereceptionpdo_to ) );?>
		</fieldset>
</fieldset>
<fieldset>
		...
		<ul class="actionMenu">
			...
			<li><?php
				echo $this->Xhtml->exportLink(
					...
					array( 'controller' => 'criterespdos', 'action' => 'exportcsv' ) + Set::flatten( $this->request->data, '__' ),
