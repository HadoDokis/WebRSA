								...
								echo $this->Xhtml->tableCells(
									array(
										...
										$this->Default2->button(
											...
											array( 
												'title' => 'Voir la fiche',
												'enabled' => ( $this->Permissions->check( 'actionscandidats_personnes', 'view' ) )
											)
										),
										$this->Default2->button(
											'edit',
											...
											array(
												...
												'enabled' => (
													$this->Permissions->check( 'actionscandidats_personnes', 'edit' )
										...
										$this->Default2->button(
											...
											array(
												...
												'enabled' => (
													$this->Permissions->check( 'actionscandidats_personnes', 'cancel' )
													&& ( Set::classicExtract( $actioncandidat_personne, 'ActioncandidatPersonne.positionfiche' ) != 'annule' )
												)
											)
										),
										$this->Default2->button(
											...
											array(
												...
												'enabled' => (
													$this->Permissions->check( 'actionscandidats_personnes', 'printFiche' )
													&& ( Set::classicExtract( $actioncandidat_personne, 'ActioncandidatPersonne.positionfiche' ) != 'annule' )
												)
											)
										),
										$this->Default2->button(
											...
											array(
												...
												'enabled' => ( 
													$this->Permissions->check( 'actionscandidats_personnes', 'maillink' )
										...
										$this->Default2->button(
											...
											array(
												...
												'enabled' => (
													$this->Permissions->check( 'actionscandidats_personnes', 'filelink' )
													&& ( Set::classicExtract( $actioncandidat_personne, 'ActioncandidatPersonne.positionfiche' ) != 'annule' )
												)
											)
										),
