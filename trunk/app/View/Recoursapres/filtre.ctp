...
<script type="text/javascript">
	...
	<fieldset>
		...
		<fieldset>
			...
			<?php echo $this->Xform->input( 'Recoursapre.datedemandeapre_to', array( 'label' => 'Au (exclus)', 'type' => 'date', 'dateFormat' => 'DMY', 'maxYear' => date( 'Y' ), 'minYear' => date( 'Y' ) - 120, 'selected' => $datedemandeapre_to ) );?>
		</fieldset>
	</fieldset>
