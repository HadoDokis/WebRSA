		...
		<div id="popup_1">
			<div class="hideshow">
				...
				<div class="popup_block">
					<div class="popup">
						<div id="popup-content1">Fichier en cours de génération... <br /> Une fois terminée, veuillez cliquer sur le bouton "Recharger la page".<div style="text-align:center;"><input type="button" onclick="location.reload()" value="Recharger la page"></div></div>
					</div>
				</div>
			</div>
		</div>
