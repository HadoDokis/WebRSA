...
<?php
	...
	$items = array(
		...
		'Tableaux de bord' => array(
			...
			'Statistiques ministérielles (brouillon)' => array(
				'Indicateurs d\'orientations' => array( 'url' => array( 'controller' => 'statistiquesministerielles2', 'action' => 'indicateurs_orientations'  ) ),
				'Indicateurs d\'organismes' => array( 'url' => array( 'controller' => 'statistiquesministerielles2', 'action' => 'indicateurs_organismes'  ) ),
				'Indicateurs de délais' => array( 'url' => array( 'controller' => 'statistiquesministerielles2', 'action' => 'indicateurs_delais'  ) ),
				'Indicateurs de caractéristiques de contrats' => array( 'url' => array( 'controller' => 'statistiquesministerielles2', 'action' => 'indicateurs_caracteristiques_contrats'  ) ),
				'Indicateurs de réorientations' => array( 'url' => array( 'controller' => 'statistiquesministerielles2', 'action' => 'indicateurs_reorientations'  ) ),
				'Indicateurs de motifs de réorientation' => array( 'url' => array( 'controller' => 'statistiquesministerielles2', 'action' => 'indicateurs_motifs_reorientation'  ) ),
			),
