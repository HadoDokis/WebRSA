...
-- FIXME: Supprimer ce qui suit cette ligne

/*

select nom, prenom, count(*) from referents group by nom, prenom having count(*) > 1;
select id from referents where nom = 'MSP' and prenom = 'Administratif';
...
SELECT * FROM derniersreferents WHERE referent_id BETWEEN 270 AND 277 ORDER BY id ASC;