		...
		*/
		...
		public function finaliser( $commissionep_id, $etape, $user_id ) {
			...
			foreach( $dossierseps as $dossierep ) {
				if ( $dossierep['Passagecommissionep'][0]['Decisionregressionorientationep93'][0]['decision'] == 'accepte' ) {
					$orientstruct = array(
						'Orientstruct' => array(
							'personne_id' => $dossierep['Dossierep']['personne_id'],
							'typeorient_id' => $dossierep['Passagecommissionep'][0]['Decisionregressionorientationep93'][0]['typeorient_id'],
							'structurereferente_id' => $dossierep['Passagecommissionep'][0]['Decisionregressionorientationep93'][0]['structurereferente_id'],
							'date_propo' => $dossierep['Regressionorientationep93']['datedemande'],
							'date_valid' => $dateseance,
							'statut_orient' => 'Orienté',
							'referent_id' => $dossierep['Passagecommissionep'][0]['Decisionregressionorientationep93'][0]['referent_id'],
							'etatorient' => 'decision',
