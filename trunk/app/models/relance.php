<?php
	...
	class Relance extends AppModel
	{
		...
		*/
		...
		public function mountComparator($data) {
		...
		*/
		...
		public function querydata( $type, $params = array() ) {
		...
		*/
		...
		public function search( $statutRelance, $mesCodesInsee, $filtre_zone_geo, $criteresrelance, $lockedDossiers ) {
			/// Conditions de base
			$conditions = array();
			...
			if( Configure::read( 'CG.cantons' ) ) {
				if( isset( $criteresrelance['Canton']['canton'] ) && !empty( $criteresrelance['Canton']['canton'] ) ) {
					$this->Canton = ClassRegistry::init( 'Canton' );
					$conditions[] = $this->Canton->queryConditions( $criteresrelance['Canton']['canton'] );
				}
			}
