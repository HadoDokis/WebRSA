	...
	class CriteresfichescandidatureController extends AppController
	{
		...
		*/
		...
		public function index() {
			...
			if( !empty( $this->data ) ) {
				...
				if( !empty( $this->data['ActioncandidatPersonne']['actioncandidat_id'] )) {
					$actioncandidatId = suffix( $this->data['ActioncandidatPersonne']['actioncandidat_id'] );
					$this->data['ActioncandidatPersonne']['actioncandidat_id'] = $actioncandidatId;
				}
		...
		*/
		...
		public function exportcsv() {
			...
			$querydata = $this->Criterefichecandidature->search( $mesCodesInsee, $this->Session->read( 'Auth.User.filtre_zone_geo' ), Xset::bump( $this->params['named'], '__' ) );
