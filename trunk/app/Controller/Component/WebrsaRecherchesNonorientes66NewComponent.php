<?php
	/**
	 * Code source de la classe WebrsaRecherchesNonorientes66NewComponent.
	 *
	 * PHP 5.3
	 *
	...
	App::uses( 'WebrsaCohortesNonorientes66New', 'Controller/Component' );

	/**
	 * La classe WebrsaRecherchesNonorientes66NewComponent ...
	 *
	 * @package app.Controller.Component
	 */
	class WebrsaRecherchesNonorientes66NewComponent extends WebrsaAbstractRecherchesNewComponent
	{
		/**
		...
		public $components = array(
			...
			'Cohortes',
			'WebrsaRecherches',
			'WebrsaCohortesNonorientes66New',
		);
		...
		protected function _optionsEnums( array $params = array() ) {
			return $this->WebrsaCohortesNonorientes66New->{__FUNCTION__}($params);
		}
